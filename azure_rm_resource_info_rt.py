...
class AzureRMResourceInfoRT(AzureRMModuleBase):
    def __init__(self):
        ...
        self.location = None
        self.subresource = []
        super(AzureRMResourceInfoRT, self).__init__(self.module_arg_spec, supports_tags=False)
    ...
    def exec_module(self, **kwargs):
        ...
        self.mgmt_client = self.get_mgmt_svc_client(GenericRestClient,
                                                    base_url="https://"+self.location+".management.azure.com/")
